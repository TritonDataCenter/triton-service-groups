...
INSERT INTO tsg_groups (id, "name", template_id, account_id, capacity, health_check_interval, archived) VALUES
	(320376470673326082, 'test-group-1', 319209784155176962, 'joyent', 3, 300, false),
	(320376528846356482, 'test-group-2', 319209801539354626, 'joyent', 3, 300, false),
	(320377354180919298, 'test-group-3', 319209812150321154, 'joyent', 6, 60, false),
	(320377452358238210, 'test-group-4', 319209821014392834, 'joyent', 1, 300, false),
	(320377513666019330, 'test-group-5', 319209831565656066, 'joyent', 3, 120, false),
	(320377641294168066, 'test-group-6', 319209841670782978, 'joyent', 12, 300, false);